          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="dark:text-gray-200">
                RIYA INDUSTRIAL SERVICES Established on the 15th of November 2017 by MR. VIKAS MANZA, He embarked on this voyage with a vision to scale new heights of success.
              </p>
              <p className="dark:text-gray-200">
            ...
            {industries.map((industry, index) => (
              ...
              >
                <div className="flex flex-col items-center text-center space-y-4">
                  <div className="w-16 h-16 flex items-center justify-center bg-gray-50 dark:bg-gray-800 rounded-lg">
                    <Image
                      src={industry.icon}
                      alt={`${industry.title} icon`}
                      width={48} 
                      height={48}
                      className="text-[#1E3A8A] group-hover:scale-110 transition-transform duration-300 object-contain"
                    />
                  </div>
